<template>
	<div id="nav">
		<div class="bg-grey">
			<div class="container py-1 px-2 d-flex text-xs border-box">
				...
				<router-link to="/order" class="text-hover-red  px-2 border-right-dark text-decoration-none"
				...
				<router-link to="/atstudy" class="text-hover-red px-2 text-decoration-none"
